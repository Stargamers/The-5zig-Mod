...
public enum c {
    ...
    private static final Map<String, c> w = Arrays.stream(values()).collect(Collectors.toMap((var0) -> d(var0.y), (var0) -> var0));
    ...
    private c(String var3, char var4, int var5, Integer var6) {
        this(var3, var4, false, var5, var6);
    }

    private c(String var3, char var4, boolean var5) {
        this(var3, var4, var5, -1, (Integer)null);
    }

    private c(String var3, char var4, boolean var5, int var6, Integer var7) {
        this.y = var3;
        this.z = var4;
        this.A = var5;
        this.C = var6;
    ...
    public static c c(String var0) {
        return var0 == null ? null : (c)w.get(d(var0));
    }
